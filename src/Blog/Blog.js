...
const Blog = () => {
    return (
        <div className='text-center'>
           <div className='mb-4'>
            <h3 className='text-xl'>1.Difference between SQL and MYSQL ?</h3>
           ...
           <div className='mb-4'>
            <h3 className='text-xl'>2. What is jwt and how does work it ?</h3>
           ...
           <div className='mb-4'>
            <h3 className='text-xl'>3. What is the difference between javascript and nodeJs</h3>
           ...
           <div  className='mb-4'>
            <h3 className='text-xl'>4. How does node js handle multiple request at the same time</h3>
